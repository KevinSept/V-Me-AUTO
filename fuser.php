        ...
        <div class="item contact padding-top-0 padding-bottom-0" id="contact1">
            ...
            <div class="wrapper grey">
                ...
                <div class="container">
                    ...
                    <h4>Selamat Datang <?php  echo $data['username'];?> </h4> 
                    <div class="col-md-5 col-md-offset-1">
                        
                        <form name="edit" method="post" action="do_edit.php?id=<?php echo $id; ?>">
                            <div class="editContent">
                                <div class="form-group row">
                                    <label for="edit-username" class="col-xs-3 col-form-label">Nama</label>
                                    <div class="col-xs-9">
                                        <input class="form-control" name="username" type="text" value="<?php echo $data['username']; ?>" required title="required" id="example-text-input">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="edit-password" class="col-xs-3 col-form-label">Password</label>
                                    <div class="col-xs-9">
                                        <input class="form-control" name="password" type="text" value="<?php echo $data['password']; ?>" required title="required" id="example-search-input">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="edit-plat" class="col-xs-3 col-form-label">Plat Nomor</label>
                                    <div class="col-xs-9">
                                        <input class="form-control" name="plat_nomer" type="plat" value="<?php echo $data['plat_nomer']; ?>" required title="required" id="example-email-input">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="edit-telp" class="col-xs-3 col-form-label">Telephone</label>
                                    <div class="col-xs-9">
                                        <input class="form-control" name="no_telp" type="tel" value="<?php echo $data['no_telp']; ?>" required title="required" id="example-tel-input">
                                  </div>
                                </div>   
                                <input type="submit" class="btn btn-primary">
                                <a href="beranda.php" type="buttoncancel" class="btn btn-danger">Kembali</a>
                            </div><!-- /.editContent -->
                        </form>
                    </div><!-- /.col-md-6 -->
                    ...
                    <div class="col-md-3 col-md-offset-1">
                        ...
                        <div class="editContent">
                                ...
                                <?php 
                                    if ($data['status'] == 0) {
                                        ?>
                                        <h4>Klik Tombol di Bawah Ini Untuk Meminta SMS ↓</h4>
                                        <a href="do_pemberitahuan.php" class="btn btn-info btn-block btn-embossed"> REQUEST SMS </a>
                                    <?php
                                        
                                    } else{
                                        echo "<br> <center>Terima kasih, <br> Anda Telah Request SMS";
                                    }
...
input[type=text], input[type=password],input[type=tel],input[type=plat],input[type=sta]  {
    width: 90%;
    padding: 12px 20px;
    margin: 8px 0;
