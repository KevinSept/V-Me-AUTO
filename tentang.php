                    ...
                    <nav role="navigation" class="navbar navbar-inverse navbar-embossed navbar-lg navbar-fixed-top">
                        ...
                        <div id="navbar-collapse-02" class="collapse navbar-collapse">
                            ...
                            ?>             
                                ...
                                <li class="active propClone"><a href="tentang.php">Tentang</a></li>
    		...
    		<div class="wrapper grey">
    			...
    			<div class="container">
    				...
    				<div class="col-md-6 col-md-offset-1">
    					...
    					<p>
                        <b class="chead"><span class="fa fa-user"></span> Tentang Kami</b><br>
    						
    						<span class="editContent">
    						<strong>Cuci mobil V&Me Auto</strong> merupakan perusahaan penyedia layanan cuci mobil & motor yang berlokasi di kota surakarta. V&Me Auto menyediakan 3 layanan utama meliputi cuci mobil, salon instant, dan salon lengkap. Adapun layanan-layanan tambahan lainnya bisa berkonsultasi langsung di lokasi V&Me Auto. Secara khusus <strong>Kami Siap Mewujudkan</strong> untuk <strong>Kebersihan Mobil Anda dan Memelihara Penggunanya</strong> 
    						</span>
    					</p>
    				
    					<p>
    						<span class="editContent">Sumber daya manusia kami memiliki kemampuan khusus dalam perawatan mobil anda dan menjamin setiap detail perawatan yang kami berikan kepada pelanggan. Promo - promo dengan harga menarik akan kami berikan secara berkala kepada pelanggan yang sudah mempercayakan perawatan mobilnya kepada kami.</span>
    					</p>
    				
    					<p>
    						<b class="chead"> Sejarah Kami</b> <br>
                            <span class="editContent"> <strong>V&Me Auto</strong> berdiri sejak tahun 2011. Pemilik dari V&Me Auto adalah bapak Edy Riyadi. Beliau tinggal di daerah makam haji kota surakarta. Awalnya V&Me Auto adalah sebuah bengkel khusus mobil yang menyediakan layanan cuci mobil sebagai pekerjaan sampingannya. Namun sejak terjadi musibah kebakaran V&Me Auto menutup bengkelnya dan menjadikannya layanan penyedia cuci mobil dan motor. Layanan ini bertahan hingga sekarang dan sudah memiliki banyak pelanggan tetap.  
                            </span>
