        ...
        <div class="item header padding-bottom-0" id="header2">
    				...
    				<nav role="navigation" class="navbar navbar-inverse navbar-embossed navbar-lg navbar-fixed-top">
    					...
    					<div id="navbar-collapse-02" class="collapse navbar-collapse">
    						<ul class="nav navbar-nav">			      
    							<li class="active propClone"><a href="index.php">Beranda</a></li>
    			...
    			<div class="container" id="successMessage">
    				...
    				<div class="row banner2">
    					...
    					<div class="col-md-6 col-md-offset-0">
    						...
    						<a href="index.php #content_section2" class="btn btn-primary btn-embossed btn-wide" ><span class="fa fa-arrow-circle-o-right"  ></span> Cek Harga</a>
                           
    				
    					</div>
                        <div class ="col-md-5 col-md-offset-1 " >
                            <div class="editContent">                            
                            <h1>Mau di SMS Ketika Mobil Sudah Selesai di Cuci ??</h1>
                            <h4>Caranya Gampang:</h4>
                            <h4>1.Daftarkan akun Sekarang <br>2.Lakukan Login <br>3.Masuk Menu Profil <br>4.Klik REQUEST SMS</h4>
                            <a href="register.php" class="btn btn-info btn-embossed btn-wide"><span class="fa fa-cloud-upload"></span> Daftar  </a>
                            </div>
                        </div>
            ...
            <div class="col-md-12">
                ...
                <div id="nivoSlider" class="nivoSlider">
                    <img src="images/carwas/1pp.jpg" alt="" class="edit" title="V&Me Auto">
                    <img src="images/carwas/2pp.jpg" alt="" title="Cuci Hidrolis Bagian Bawah Mobil" class="edit">
                    <img src="images/carwas/3pp.jpg" alt="" title="Cuci Salju / Snow Wash" class="edit">
                    <img src="images/carwas/4p.jpg" alt="" title="Pembersihan Bagian Dalam Mobil" class="edit">
                    <img src="images/carwas/5p.jpg" alt="" title="Pengelapan mobil setelah di cuci" class="edit">
                </div>
