        ...
        <div class="wrapper grey">    
            ...
            <script language="javascript">
                    ...
                    function checkPassword(){
                        ...
                        <a href="index.php" type="buttoncancel" class="btn btn-default">Cancel</a>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-5">
                    ...
                    <div class="editContent">
                        <h3>Car Washwash adalah tempat <strong>Cuci Mobil</strong> yang berkualitas tinggi</h3>
                    </div>
                    <div class="editContent">
                        <p class="lead">Giving Your Car <strong>The Best Cleaning</strong> and Make Your Car Look <strong>as Good as New</strong></p>
                    </div>
                </div>
